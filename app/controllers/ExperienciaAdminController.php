...
class ExperienciaAdminController
{
    ...
    {
        $experiencia = null;
        $accion      = BASE_URL . '/tom-workspace/experiencia/guardar';
    ...
    public function guardar(): void
    {
        ...
        header('Location: ' . BASE_URL . '/tom-workspace/experiencia');
        exit;
    }
    ...
    public function editar(int $id): void
    {
        ...
        $accion = BASE_URL . '/tom-workspace/experiencia/actualizar/' . $id;
        require __DIR__ . '/../../views/admin/experiencia/formulario.php';
    }
