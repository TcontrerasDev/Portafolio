...
class HabilidadAdminController
{
    ...
    public function crear(): void
    {
        ...
        $accion     = BASE_URL . '/tom-workspace/habilidades/guardar';
    ...
    public function guardar(): void
    {
        ...
        header('Location: ' . BASE_URL . '/tom-workspace/habilidades');
        exit;
    }
    ...
    public function editar(int $id): void
    {
        ...
        $categorias = $this->modeloCategorias->obtenerTodos();
        $accion     = BASE_URL . '/tom-workspace/habilidades/actualizar/' . $id;
        require __DIR__ . '/../../views/admin/habilidades/formulario.php';
    }
