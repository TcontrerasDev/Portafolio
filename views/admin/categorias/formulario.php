...
$breadcrumb   = [
  ['label' => 'Categorías habilidades', 'url' => BASE_URL . '/tom-workspace/categorias'],
...
<div class="page-header">
  <h1 class="page-title"><?= $esEdicion ? 'Editar categoría' : 'Nueva categoría' ?></h1>
</div>
    ...
    <div class="form-section">
      <form method="post" action="<?= htmlspecialchars($accion, ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="form-actions">
          ...
          <a href="<?= BASE_URL ?>/tom-workspace/categorias" class="btn btn-outline">Cancelar</a>
        </div>
      </form>
    </div>
  </div>
