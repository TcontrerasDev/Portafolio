...
$breadcrumb   = [['label' => 'Habilidades', 'url' => BASE_URL . '/tom-workspace/habilidades']];
require __DIR__ . '/../layout/header.php';
?>

<div class="page-header">
  <h1 class="page-title">Habilidades</h1>
  <a href="<?= BASE_URL ?>/tom-workspace/habilidades/crear" class="btn btn-primary">
          ...
          <tr>
            ...
            <td>
              <div class="actions-cell">
                <a href="<?= BASE_URL ?>/tom-workspace/habilidades/editar/<?= (int)$h['id'] ?>" class="btn btn-sm btn-outline btn-icon" title="Editar">
                  <i class="bi bi-pencil"></i>
                </a>
                <form method="post" action="<?= BASE_URL ?>/tom-workspace/habilidades/eliminar/<?= (int)$h['id'] ?>"
                      data-confirm="¿Eliminar esta habilidad?">
